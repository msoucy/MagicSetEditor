 ...
 *  Whenever text is used that can be translated to another language (and is not
 *code related)
...
/// Format a string
/** Equivalent to sprintf / String::Format, but allows strings to be passed as
 * arguments (gcc)
 */
