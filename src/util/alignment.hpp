...
/// How much should an object with obj_width be moved to be aligned in a box
/// with box_width?
double align_delta_x(Alignment align, double box_width, double obj_width);

/// How much should an object with obj_height be moved to be aligned in a box
/// with box_height?
...
/** If the direction is horizontal the to_move.width is used, otherwise
 * to_move.height */
RealPoint move_in_direction(Direction dir, const RealPoint &point,
							const RealSize to_move, double spacing = 0);
