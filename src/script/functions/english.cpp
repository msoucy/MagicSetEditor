...
bool is_vowel(Char c) {
    return c == (L'a') || c == (L'e') || c == (L'i') || c == (L'o') ||
           c == (L'u') || c == (L'A') || c == (L'E') || c == (L'I') ||
           c == (L'O') || c == (L'U');
}
...
String english_number(int i) {
    ...
    default: {
        if (i < 0 || i >= 100) {
            ...
            // <a>ty-<b>
            return english_number(i / 10 * 10) + (L"-") +
                   english_number(i % 10);
        }
    }
    }
...
String english_singular(const String &str) {
    if (str.size() > 3 && is_substr(str, str.size() - 3, (L"ies"))) {
        ...
        return str.substr(0, str.size() - 2);
    } else if (str.size() > 5 && is_substr(str, str.size() - 3, (L"ves")) &&
               (is_substr(str, str.size() - 5, (L"el")) ||
                is_substr(str, str.size() - 5, (L"ar")))) {
    ...
    for (size_t i = 0; i < str.size();) {
        ...
        if (is_substr(str, i, (L"<hint-"))) {
            ...
            if (after != String::npos) {
                ...
                } else if (is_substr(str, after, (L"</param-")) &&
                           ret.size() >= 1 &&
...
void init_script_english_functions(Context &ctx) {
    ...
    ctx.setVariable((L"english_number_multiple"),
