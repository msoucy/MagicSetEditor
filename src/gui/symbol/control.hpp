...
/** What kind of editing is done is determined by the contained SymbolEditorBase
 * object
 *  That object handles all events and the drawing. This class is mostly just a
 * proxy.
 */
