...
class SymbolPointEditor : public SymbolEditorBase {
  ...
  private:
	...
	void drawControlPoint(DC &dc, const ControlPoint &p, bool drawHandleBefore,
  ...
  private:
	...
	//   line
	ControlPointP selected_line1,
		selected_line2;		// selected the line between these points
	...
	Vector2D new_point;
	//   line
	ControlPointP hover_line_1,
		hover_line_2; // hovering on the line between these points
	double hover_line_t;
	...
	/// Finds the item that is currently being hovered, stores the results in
	/// hover*
