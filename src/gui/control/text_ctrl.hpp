...
/** Implemented using a DataEditor. A fake Field and Value are created for the
 *item.
 *
 *  TODO:
 *  Possible problem: If multiple TextCtrls are editing the same value they will
 *both
 *                    create a Value, actions modifying one of them will not
 *match with actions modifying the other
...
class TextCtrl : public DataEditor {
  public:
	TextCtrl(Window *parent, int id, bool multi_line,
