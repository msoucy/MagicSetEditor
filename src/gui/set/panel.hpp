...
/** This class is a virtual base class for all actual panels used in the set
 * window.
 */
class SetWindowPanel : public wxPanel, public SetView {
  public:
    ...
    //information
    //
    //	virtual String helpFile()    { return (L""); } ///< help file to use
    ...
    // --------------------------------------------------- : Selection
    virtual CardP
    selectedCard() const; ///< Return the currently selected card, or CardP()
