...
/// Id of the control that has the focus in the given window, or -1 if no
...
/// Set the help text for a window, it will be shown in the status bar on mouse
/// over
...
/// Fill a newly allocated DC with black, if the platform doesn't do so
/// automaticly
...
void draw_selection_rectangle(Window *win, DC &dc, const wxRect &rect,
							  bool selected = true, bool focused = true,
							  bool hot = false);
