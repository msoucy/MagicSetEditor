...
SymbolPartP read_new<SymbolPart>(Reader &reader) {
    ...
    if (type == (L"shape") || type.empty())
        return intrusive(new SymbolShape);
    else if (type == (L"symmetry"))
...
String SymbolShape::typeName() const { return (L"shape"); }
...
String SymbolSymmetry::typeName() const { return (L"symmetry"); }
...
String SymbolGroup::typeName() const { return (L"group"); }
