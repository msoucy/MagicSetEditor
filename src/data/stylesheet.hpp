...
class StyleSheet : public Packaged {
  public:
    ...
    bool dependencies_initialized; ///< are the script dependencies comming from
                                   ///this stylesheet all initialized?

    inline RealRect getCardRect() const {
        return RealRect(0, 0, card_width, card_height);
    }

    /// Return the style for a given field, it is not specified what type of
    /// field this is.
...
inline String type_name(const StyleSheet &) { return _TYPE_("stylesheet"); }
