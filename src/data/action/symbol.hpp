...
class SymbolPartMatrixAction : public SymbolPartsAction {
  public:
    SymbolPartMatrixAction(const set<SymbolPartP> &parts,
...
class SymbolPartRotateAction : public SymbolPartMatrixAction {
  public:
    SymbolPartRotateAction(const set<SymbolPartP> &parts,
                           const Vector2D &center);
...
class SymbolPartShearAction : public SymbolPartMatrixAction {
  public:
    SymbolPartShearAction(const set<SymbolPartP> &parts,
                          const Vector2D &center);
...
class SymbolPartScaleAction : public SymbolPartsAction {
  public:
    SymbolPartScaleAction(const set<SymbolPartP> &parts, int scaleX,
                          int scaleY);
  ...
  private:
    ...
    Vector2D new_real_min, new_real_size; ///< the target pos/sizevoid
                                          ///shearBy(const Vector2D& shear)
    Vector2D new_min,
        new_size;       ///< the target pos/size after applying constrains
...
class CombiningModeAction : public SymbolPartsAction {
  ...
  private:
    ...
    vector<std::pair<SymbolShapeP, SymbolShapeCombine>>
        parts; ///< Affected parts with new combining modes
};
...
class RemoveSymbolPartsAction : public SymbolPartListAction {
  ...
  public:
    /// A removal step
    struct Removal {
        inline Removal(SymbolGroup &parent, size_t pos,
                       const SymbolPartP &removed)
...
class ReorderSymbolPartsAction : public SymbolPartListAction {
  public:
    ReorderSymbolPartsAction(SymbolGroup &old_parent, size_t old_position,
                             SymbolGroup &new_parent, size_t new_position);
...
class UngroupReorderSymbolPartsAction : public SymbolPartListAction {
  public:
    ...
    UngroupReorderSymbolPartsAction(SymbolGroup &group_parent, size_t group_pos,
...
class GroupSymbolPartsAction : public GroupSymbolPartsActionBase {
  public:
    GroupSymbolPartsAction(SymbolGroup &root, const set<SymbolPartP> &parts,
