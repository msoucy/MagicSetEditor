...
GameSettings::GameSettings()
    : sort_cards_ascending(true), images_export_filename((L"{card.name}.jpg")),
...
Settings::Settings()
    : locale((L"en")), set_window_maximized(false), set_window_width(790),
...
String Settings::settingsFile() {
    ...
    return user_settings_dir() + (L"mse8.config"); // use different file during
